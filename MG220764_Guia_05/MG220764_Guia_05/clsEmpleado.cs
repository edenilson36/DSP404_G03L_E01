...
namespace MG220764_Guia_05
{
    internal class clsEmpleado
    {
        ...
        private Boolean DatosLaboralesListo;
        ...
        public Boolean datoslaborales_aceptados
        {
            get
            {
                return DatosLaboralesListo;
            }
        }

        //Metodos

        public clsEmpleado()       //Metodo Constructor
        {
        ...
        public void DefinirDatosPersonales(string nom, string apel1, DateTime fechanac)
        {
            ...
            else Nombres = nom;     //asignar parametro recibido a atributo nombres
        ...
        public void DefinirDatosLaborales(DateTime fechacontrato, decimal sueldoinic)
        {
            ...
            long totalannos;    //diferencia años entre 2 cualquiera

            DateTime fechainic18;    //fecha min laboral de empleado segun su fecha nacimiento
            ...
            if (!(DatosCompletos))
            {
                MessageBox.Show("Datos laborales no aceptos", "ERROR",
            ...
            //Determina si diferencia fecha contrato esta ubucada entre 18 años despues
        ...
        public void AsignarDescuentos(decimal isss= 2.50m, decimal renta = 10.50m)
        {
            ...
            {
                TasaRenta = 10.5m;     //asignar tasa 10.5% predeterminado
            }
        }
