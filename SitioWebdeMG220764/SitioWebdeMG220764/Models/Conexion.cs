...
namespace SitioWebdeMG220764.Models
{
    public class Conexion
    {
        ...
        //Funcion para realizar conexion a base de datos SQLserver

        public bool conectar()
        {
            try
            {
                //crea objeto SQLConnection y enviar como parametros de las credenciales de conexion
        ...
        //Metodo que verifica si el estado de la conexion es abierta o cerrada en la aplicacion
        ...
        public List<SelectListItem> getCategorias()
        {
            ...
            try
            {
                ...
                //verifica si, se encuentra resultados 
                ...
                if (lector.HasRows) {
                    ...
                    while (lector.Read())
                    {
                        //agrega datos de caracter al Dropdownlist

                        items.Add(new SelectListItem
                        {
                            Text = lector["nSNombreCategoria"].ToString(),
                            Value = lector["nldCategoria"].ToString()
                        }
                        );
                    }
