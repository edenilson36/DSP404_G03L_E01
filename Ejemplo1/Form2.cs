    ...
    public partial class Form2 : Form
    {
        ...
        private void btnAnalisis_Click(object sender, EventArgs e)
        {
            ...
            if (NomEmpre.Length == 0) {
                ...
                txtMonto.Focus(); //metodo que indica que contol txtEmpresa recibira cursor
            ...
            IstResul.Items.Clear();
            IstResul.Items.Add("Empresa: " + txtEmpresa.Text);
            IstResul.Items.Add("Monto: $" + MontoInic + ", Tasa anual: " + TasaI);
            IstResul.Items.Add("Monto a pagar: $" + MontoFin);
        }
    }
}
